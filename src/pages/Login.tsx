...
const Login = () => {
  return (
    ...
    <TeamworkLogo logoStyle="flex gap-3 items-center mb-10" logoIcon={<RiGroupLine className=" bg-gray-200/20 p-3 rounded-2xl" size={55}/>} logoTextStyle="text-4xl font-semibold" />

    <div className="flex flex-col gap-4 align-center mb-4">
        <h1 className="text-[3.5rem] font-medium leading-none">Connect with your <br /> colleagues</h1>
    ...
    <TeamworkLogo logoStyle="flex gap-3 items-center mb-10 md:hidden" logoIcon={<RiGroupLine className="theme_background text-white p-3 rounded-2xl" size={50}/>} logoTextStyle="text-3xl font-semibold" />
    ...
    <p className="text-gray-500 text-md">Don't have an account? <small className="theme_text hover:underline">Contact an admin for more information.</small></p>
    </div>
